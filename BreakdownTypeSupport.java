...
public class BreakdownTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Breakdown";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BreakdownTypeSupport _singleton
    = new BreakdownTypeSupport();
    ...
    */
    public static BreakdownTypeSupport get_instance() {
        return _singleton;
    }

    public static BreakdownTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BreakdownTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Breakdown</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Breakdown typedDst = (Breakdown) destination;
        Breakdown typedSrc = (Breakdown) source;
        ...
        Object sample) 
    {
        ...
        Breakdown typedSrc = (Breakdown) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Breakdown typedDst = (Breakdown) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Breakdown typedDst = (Breakdown) sample;
    ...
    int mask) {
        return new BreakdownDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BreakdownDataReader(native_reader, listener, mask, this);   
    ...
    protected BreakdownTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BreakdownTypeCode.VALUE,Breakdown.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BreakdownTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BreakdownTypeCode.VALUE,Breakdown.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
