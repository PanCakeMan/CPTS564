...
*/
public final class AccidentSeq2 extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AccidentSeq2 (int initialMaximum) {
        super(Accident.class, initialMaximum);
    }

    public AccidentSeq2 (Collection elements) {
