...
public class VehicleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Vehicle";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final VehicleTypeSupport _singleton
    = new VehicleTypeSupport();
    ...
    */
    public static VehicleTypeSupport get_instance() {
        return _singleton;
    }

    public static VehicleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return VehicleTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Vehicle</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Vehicle typedDst = (Vehicle) destination;
        Vehicle typedSrc = (Vehicle) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += BreakdownTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += AccidentTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += PositionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += BreakdownTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += AccidentTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += PositionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        Vehicle typedSrc = (Vehicle) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.vId );

        currentAlignment += BreakdownTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.breakdown);

        currentAlignment += AccidentTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.accident);

        currentAlignment += PositionTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += BreakdownTypeSupport.get_instance().get_serialized_key_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.vId,255);

            BreakdownTypeSupport.get_instance().serialize(endpoint_data, typedSrc.breakdown, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            AccidentTypeSupport.get_instance().serialize(endpoint_data, typedSrc.accident, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            PositionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.position, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            BreakdownTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.breakdown, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Vehicle typedDst = (Vehicle) dst;
            typedDst.clear();      
            try{
                typedDst.vId = src.readString(255);
                typedDst.breakdown = (Breakdown)BreakdownTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.breakdown, src, false, true, endpoint_plugin_qos);     
                typedDst.accident = (Accident)AccidentTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.accident, src, false, true, endpoint_plugin_qos);     
                typedDst.position = (Position)PositionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.position, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_key) {
            ...
            typedDst.breakdown = (Breakdown)BreakdownTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.breakdown, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            BreakdownTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            AccidentTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            PositionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Vehicle typedDst = (Vehicle) sample;

            src.skipString();

            typedDst.breakdown = (Breakdown)BreakdownTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.breakdown, src, false, true, endpoint_plugin_qos);     
    ...
    */
    ...
    int mask) {
        return new VehicleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new VehicleDataReader(native_reader, listener, mask, this);   
    ...
    protected VehicleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,VehicleTypeCode.VALUE,Vehicle.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected VehicleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,VehicleTypeCode.VALUE,Vehicle.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
